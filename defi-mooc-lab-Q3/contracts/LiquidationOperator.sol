...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IERC20 constant USDC = IERC20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // 6 Deciaml points

    IUniswapV2Factory constant uniswapV2Factory = IUniswapV2Factory(0x5C69bEe701ef814a2B6a3EDD4B1652CB9cc5aA6f);
    IUniswapV2Pair immutable uniswapV2Pair_WETH_USDC; // Pool for flashloan and swaps
    // IUniswapV2Pair immutable uniswapV2Pair_WBTC_WETH; // only one pool needed
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_USDC_Pool1, uint256 reserve_WETH_Pool1, ) = uniswapV2Pair_WETH_USDC.getReserves(); // Pool1 (Editted to WBTC,USDT instead)
