...
contract LiquidationOperator is IUniswapV2Callee {
    ...
    IUniswapV2Pair immutable uniswapV2Pair_WBTC_USDT; // Pool1 for liquidating
    IUniswapV2Pair immutable uniswapV2Pair_WBTC_WETH; // Pool2 for calculating profit
    ...
    constructor() {
        ...
        debt_USDT = 2000000000; // USDT = 6 Decimal points , change for 2000,5000,10000
    ...
    function uniswapV2Call(
        ...
        (uint256 reserve_WBTC_Pool1, uint256 reserve_USDT_Pool1, ) = uniswapV2Pair_WBTC_USDT.getReserves(); // Pool1 (Editted to WBTC,USDT instead)
        ...
        // 2.2 Repaying the (WBTC) debt -- may or may not have WBTC left over
        ...
        uint WBTC_left = WBTC.balanceOf(address(this));

        // 2.3 swap all the WBTCs left for WETH
        WBTC.transfer(address(uniswapV2Pair_WBTC_WETH), WBTC_left);
        uint amountOut_WETH = getAmountOut(WBTC_left, reserve_WBTC_Pool2, reserve_WETH_Pool2);
